...
import { TrendingUp, Calculator, Database, Info } from "lucide-react";
        ...
        <div className="relative container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
              Professional-grade European option pricing using Black-Scholes analytical solutions 
              and Monte Carlo simulations with real-time Greeks calculation
            </p>
